...
export SPARK_SLURM_PATH=/home/karimy/spark-slurm/spark_preemptable_full_node
...
for i in 4; do
./SparkLeMakeAndSearch.sh -i /fastscratch/karimy/blastDB/uniprot_sprot.fasta -t /localscratch/uniprot_sprot_formatted -q /fastscratch/karimy/blastDB/geobacter_8_partitions/GeobacterMetallireducens_8.fasta -o T  -dbtype prot -p ${i} -w ${i} -time 120 -h inf -d /fastscratch/karimy/SparkLogs
done
